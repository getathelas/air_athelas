...
This page is the **Export Format Documentation** for Electronic Health Information (EHI) produced by Air, as required by **ONC §170.315(b)(10)**. It describes the file formats Air emits so that a recipient can read, parse, and computably consume the exported data without contacting Athelas.
...
For an EHI export covering **all patients** in your practice (population-level export per §170.315(b)(10)(i)(B)), contact Athelas support:
