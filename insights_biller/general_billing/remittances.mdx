---
title: "Remittances"
description: "Reconcile deposits, checks, and insurance remittances in Insights."
---
...
- **Deposit Method** — select **BAI** to focus on deposits imported from BAI transactions.
