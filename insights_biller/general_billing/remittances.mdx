---
title: "Remittances"
description: "Reconcile insurance deposits, checks, remittances, and bank activity in Insights."
---
...
###### Uploading an 835 file

In the **Create Check** drawer, the **Upload 835 file** chooser accepts `.835`, `.edi`, `.txt`, `.dat`, `.csv`, and `.json` files.
