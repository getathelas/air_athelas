...
description: "Review claim context, activity, and submission previews from the Claims Page."
toc: "true"
---
...
- **Actions** — the primary **Submit** action sits prominently in blue. Open **More Actions** to **Review** (`R`) or **Preview** (`P`) the claim, or choose secondary actions such as push to PR, adjust, request an appeal, or defer. **Preview** is disabled while preview mode is active.
