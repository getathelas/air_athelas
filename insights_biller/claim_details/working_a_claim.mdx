...
description: "Review claim context, request appeals, track activity, and preview billing rules in Insights."
toc: "true"
---
...
**Prerequisite:** The claim must have at least one denied submission.

1. Open the denied claim, select **Actions**, and choose **Request Appeal**.
2. Under **Choose which submission to appeal**, select a denied submission.
3. Select **Submit**.

A submission is unavailable when it already has an open appeal task. Hover over the unavailable submission to see why it can't be selected. If every denied submission already has an open appeal task, you can't submit another appeal request.
