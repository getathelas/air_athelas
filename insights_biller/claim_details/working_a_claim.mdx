...
description: "Review claim context, submission history, payments, and Activity Feed events in Insights."
toc: "true"
---
...
| **Event** | **What it means** |
| :-- | :-- |
| **Drafted a claim submission** | A draft submission was created for the claim. |
| **Queued a claim for submission** | The claim is waiting to be submitted to the listed insurance. The event may also show the billed amount. |
| **Submitted a claim** | The claim was submitted to the listed insurance. The event identifies corrected, resubmitted, and voided claims and may show the billed amount. |
| **Reviewed the claim** | A manual claim review finished. The event shows whether validation passed or found issues. |
| **Failed to submit a claim** | The submission attempt failed. Expand the event to see the failure reason when one is available. |
