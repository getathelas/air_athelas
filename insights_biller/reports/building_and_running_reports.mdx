...
<Note>
Looking at this from the **Air** tab instead? See [Review your Reports](/air_admin/analyze_your_reports/all_reports) for the same My Reports page from that side of the docs.
</Note>
...
- If your practice uses Air, those reports are available here. See [EHR Reports](/air_admin/analyze_your_reports/ehr_reports) for an overview of the three report engines, and [Building a Report](/air_admin/analyze_your_reports/building_a_report) for how to configure and run one.
