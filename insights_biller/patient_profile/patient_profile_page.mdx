...
description: "Manage a patient's full financial picture — charges, transactions, credits, and balance — with the Athelas Assistant balance explainer."
---
...
The status controls let you manage how Insights interacts with the patient: toggle automatic text messages on or off, set up a payment plan, or mark the account as **In Collections**. Changes take effect immediately and are logged in the patient's activity history.
...
![Athelas Assistant Tracing Credits](/images/insights_biller/patient_profile/patient_profile_page/patient_profile_page_8.png)
