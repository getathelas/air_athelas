...
description: "Learn how to add patients, manage appointments, and use the calendar as a staff member in Air Billing"
---
...
<Frame>
<img src="/images/insights_onboard/getting_started_as_a_staff_member/getting_started_as_a_staff_member_1.png" alt="Patient creation side panel with demographics form" />
</Frame>
</Step>
...
<Frame>
<img src="/images/insights_onboard/getting_started_as_a_staff_member/getting_started_as_a_staff_member_2.png" alt="Insurance information form with policy details" />
</Frame>
...
<Frame>
<img src="/images/insights_onboard/getting_started_as_a_staff_member/getting_started_as_a_staff_member_3.png" alt="Guarantor information form for non-self relationships" />
</Frame>
...
<Frame>
<img src="/images/insights_onboard/getting_started_as_a_staff_member/getting_started_as_a_staff_member_4.png" alt="Worker's compensation insurance form with accident date and claim number fields" />
</Frame>
</Step>
...
<Frame>
<img src="/images/insights_onboard/getting_started_as_a_staff_member/getting_started_as_a_staff_member_5.png" alt="Self-pay insurance option selected" />
</Frame>
...
<Frame>
<img src="/images/insights_onboard/getting_started_as_a_staff_member/getting_started_as_a_staff_member_6.png" alt="Missing insurance option selected" />
</Frame>
</Step>
...
<Frame>
<img src="/images/insights_onboard/getting_started_as_a_staff_member/getting_started_as_a_staff_member_7.png" alt="Create button at bottom of patient creation form" />
</Frame>
</Step>
</Steps>
...
<Frame>
<img src="/images/insights_onboard/getting_started_as_a_staff_member/getting_started_as_a_staff_member_8.png" alt="Patient demographics page with cases section" />
</Frame>
</Step>
...
<Frame>
<img src="/images/insights_onboard/getting_started_as_a_staff_member/getting_started_as_a_staff_member_9.png" alt="Case creation form with case name, referring provider, and case notes fields" />
</Frame>
</Step>
...
<Frame>
<img src="/images/insights_onboard/getting_started_as_a_staff_member/getting_started_as_a_staff_member_10.png" alt="Prior authorization section with new prior auth button" />
</Frame>

<Frame>
<img src="/images/insights_onboard/getting_started_as_a_staff_member/getting_started_as_a_staff_member_11.png" alt="Prior authorization creation form with auth number, visits, dates, and insurance fields" />
</Frame>
</Step>
...
<Frame>
<img src="/images/insights_onboard/getting_started_as_a_staff_member/getting_started_as_a_staff_member_12.png" alt="Patient attachments tab showing intake forms and uploaded documents" />
</Frame>
</Step>
</Steps>
...
<Frame>
<img src="/images/insights_onboard/getting_started_as_a_staff_member/getting_started_as_a_staff_member_13.png" alt="Calendar view showing daily appointments and schedule" />
</Frame>
...
<Frame>
<img src="/images/insights_onboard/getting_started_as_a_staff_member/getting_started_as_a_staff_member_14.png" alt="Calendar page with filters icon in top right corner" />
</Frame>
</Step>
...
<Frame>
<img src="/images/insights_onboard/getting_started_as_a_staff_member/getting_started_as_a_staff_member_15.png" alt="Filter side panel with provider, facility, appointment type, insurance, and patient options" />
</Frame>
...
<Frame>
<img src="/images/insights_onboard/getting_started_as_a_staff_member/getting_started_as_a_staff_member_16.png" alt="Schedule block showing case, eligibility, payment, and appointment status" />
</Frame>
...
<Frame>
<img src="/images/insights_onboard/getting_started_as_a_staff_member/getting_started_as_a_staff_member_17.png" alt="Hover popup on calendar block showing available actions" />
</Frame>

<Frame>
<img src="/images/insights_onboard/getting_started_as_a_staff_member/getting_started_as_a_staff_member_18.png" alt="Additional hover actions menu" />
</Frame>
...
<Frame>
<img src="/images/insights_onboard/getting_started_as_a_staff_member/getting_started_as_a_staff_member_19.png" alt="Appointment detail side menu showing comprehensive appointment information" />
</Frame>

**Edit appointment:** Click the pencil icon at the top of the Appointment Detail side menu to edit appointment details.

<Frame>
<img src="/images/insights_onboard/getting_started_as_a_staff_member/getting_started_as_a_staff_member_20.png" alt="Pencil icon for editing appointment details" />
</Frame>
...
<Frame>
<img src="/images/insights_onboard/getting_started_as_a_staff_member/getting_started_as_a_staff_member_21.png" alt="Three-dot menu with additional appointment actions" />
</Frame>
...
<Frame>
<img src="/images/insights_onboard/getting_started_as_a_staff_member/getting_started_as_a_staff_member_22.png" alt="Create New button in calendar header" />
</Frame>
...
<Frame>
<img src="/images/insights_onboard/getting_started_as_a_staff_member/getting_started_as_a_staff_member_23.png" alt="Empty calendar slot for creating appointment" />
</Frame>
...
<Frame>
<img src="/images/insights_onboard/getting_started_as_a_staff_member/getting_started_as_a_staff_member_24.png" alt="Patient appointments page with new appointment button" />
</Frame>

<Frame>
<img src="/images/insights_onboard/getting_started_as_a_staff_member/getting_started_as_a_staff_member_25.png" alt="New Appointment and Book Appointment buttons" />
</Frame>
...
<Frame>
<img src="/images/insights_onboard/getting_started_as_a_staff_member/getting_started_as_a_staff_member_26.png" alt="Appointment creation side panel with form fields" />
</Frame>
...
<Frame>
<img src="/images/insights_onboard/getting_started_as_a_staff_member/getting_started_as_a_staff_member_27.png" alt="Appointment form showing optional fields for referring provider and prior authorizations" />
</Frame>
...
<Frame>
<img src="/images/insights_onboard/getting_started_as_a_staff_member/getting_started_as_a_staff_member_28.png" alt="Referring provider search field with NPI number lookup" />
</Frame>
...
<Frame>
<img src="/images/insights_onboard/getting_started_as_a_staff_member/getting_started_as_a_staff_member_29.png" alt="Appointments table with checkboxes for bulk fax and download" />
</Frame>

<Frame>
<img src="/images/insights_onboard/getting_started_as_a_staff_member/getting_started_as_a_staff_member_30.png" alt="Selected appointments ready for bulk fax or download" />
</Frame>
...
<Frame>
<img src="/images/insights_onboard/getting_started_as_a_staff_member/getting_started_as_a_staff_member_31.png" alt="Utilities menu with Faxing section highlighted" />
</Frame>
