...
<Card title>
  ...
  **Note:** Cases can also be created in the **<u>Demographics tab</u>** of the patient profile.
</Card>
...
<Card title>
  ...
  \*\*Note: \*\*Prior authorizations can also be managed under the patient’s **<u>Demographics tab.</u>**
</Card>
...
<Card title>
  Create schedule blocks for meetings, vacations, or admin time. Use **Create New → Bulk Create Appointments** or click directly on the calendar. Choose the provider, title, time/date, and recurrence.
</Card>
