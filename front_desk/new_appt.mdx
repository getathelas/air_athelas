...
<Card title>
  ...
  1. [Appointment Notes](https://trainings.air.athelas.com/patient_details/patient_info#add-patient-notes)
  2. [Case Notes](https://trainings.air.athelas.com/patient_details/patient_info#add-patient-notes)
  3. [Patient Notes (pinned, general)](https://trainings.air.athelas.com/patient_details/patient_info#add-patient-notes)
</Card>
...
<Card title>
  ...
  \*\*Note: \*\*You can bulk-schedule with a primary and a backup (alternate) provider. The calendar shows availability for both, you can pick who covers each date, and the system creates the right appointments under the right provider. If your practice policy allows you can also note credentialing exceptions during scheduling.
</Card>

<Accordion title="FAQ: Updating a case after the appointment is completed">
