...
<Card title>
  ...
  **Changing Task Status:** You can edit, delete, or update the status of a task by clicking the corresponding icons.
  ...
  **Sorting Tasks:** Click the arrow in any column header to sort by ascending, descending, or neutral order. Shift-Sort - Sort one column, then hold _Shift_ while sorting another column to apply multiple sorting rules.

  \*\*Viewing Archived Tasks: \*\*To view archived tasks, use the Filter in the upper-right corner and include Archived in the statuses shown.
</Card>