...
<Card title>
  ...
  **Tracking Prior Auth Status:**
  ...
  - To review all prior authorizations open the **Encounter Details** tab (under Daily Operations) in the left navigation bar. You can filter all encounters by **Has Prior Auth** as True or False to find all encounters in a given data range that are missing prior authorization.
  ...
  - From here you can filter based on the expiration date to see if prior auths need to be updated.
...
<Card title=" ">
  ...
  **From the calendar**
  ...
  - Go to the Calendar \> Open an appointment \> click on the carot icon to open the appointment details
