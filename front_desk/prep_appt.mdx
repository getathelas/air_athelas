...
<Card title>
  ...
  **Tracking Prior Auth Status:**
  ...
  Further, you can filter all encounters by **Has Prior Auth** as True or False to find all future encounters in a given data range that are missing prior authorization.
