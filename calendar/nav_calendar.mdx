...
<Steps>
  <Step title="Open your Calendar" iconType="sharp-solid" stepNumber={1} titleSize="h2">
    <Card title=" ">
  ...
  <Step title="Set your Time and Compact preferences" titleSize="h2">
    <Card title=" ">
  ...
  <Step title="Instantly view key appointment information" iconType="solid" stepNumber={3} titleSize="h2">
    <Card title=" ">
      <Danger>
