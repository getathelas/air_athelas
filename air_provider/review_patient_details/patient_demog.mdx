...
<Card title=" ">
  ![13 Pt Demographics Gi](/images/air_provider/review_patient_details/patient_demog/patient_demog_1.gif)
...
<Card title=" ">
  ...
  **Note: **A chart note can also be changed to a discharge note, which adjusts the template of sections.
  ...
  ![15 Case Discharge Gi](/images/air_provider/review_patient_details/patient_demog/patient_demog_1.gif)
  ...
  **Restore a Discharged case**: Restore an incorrectly discharged case by clicking on the time icon.
  ...
  <img
    src="/images/air_provider/review_patient_details/patient_demog/patient_demog_1.webp"
...
<Card title=" ">
  ...
  ![14 Active Cases Gi](/images/air_provider/review_patient_details/patient_demog/patient_demog_1.gif)

  **Click on the edit case icon to update the following:**

  - Supervising Provider on the case
  - Case Owning Provider on the case (also used to calculate the [Active Patient Breakdown](https://trainings.air.athelas.com/reports/kpi_dashboard#review-the-status-of-active-patients) report)
  - Add or view case notes for the patient

  ![Update Case Owner Prov Web](/images/air_provider/review_patient_details/patient_demog/patient_demog_1.webp)
</Card>