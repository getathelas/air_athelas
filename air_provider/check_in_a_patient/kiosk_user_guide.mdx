...
### <Icon icon="gear" iconType="duotone" color="#F9345F" size={23} />  Enable Kiosk in Air Billing
...
### <Icon icon="palette" iconType="duotone" color="#F9345F" size={23} />  Branding
...
### <Icon icon="chart-column" iconType="duotone" color="#F9345F" size={23} />  Adoption reporting
...
### <Icon icon="desktop" iconType="duotone" color="#F9345F" size={23} />  Staff check-in
...
<Accordion title="Can a patient get a receipt for a kiosk payment?">
