...
description: "Set up the Athelas Kiosk and guide patients through self-service check-in and intake forms."
toc: "true"
---
...
If your practice has kiosk intake forms enabled and the patient has unfinished forms, the kiosk opens **Your forms** after payment. The patient completes each form directly on the full-page form screen. When multiple forms are assigned, the header shows the patient's progress as **Form 1 of 2**, and **Skip this form** moves to the next form without marking the current form complete. **Continue to Check-In** becomes available after all forms are complete.

Once payment clears and any intake forms are complete, the patient sees a confirmation screen and taps **Finish** to return the kiosk to the welcome screen for the next patient.
