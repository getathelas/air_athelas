...
<Card title=" ">
  ...
  ![9 Ai Checkin Gi](/images/air_provider/check_in_a_patient/check_in/check_in_1.gif)

  **Note**: To check in an Appointment a [Case Type](https://trainings.air.athelas.com/check-in/edit_appt#change-the-case-type) must be present. If no case is associated, you will receive an error when attempting to check in.
...
<Card title=" ">
  ...
  **Note**: You can also "uncheck-in" the patient if checked-in by mistake.
  ...
  ![8 Checkin Options Gi](/images/air_provider/check_in_a_patient/check_in/check_in_1.gif)
