...
<Card title>
  **View Forms:**
  ...
  - You will be able to view the scores here.
    ...
    ![Fotm Chartnote Web](/images/air_provider/fill_a_chart_note/functional_outcomes/functional_outcomes_1.webp)
  ...
  - As a provider, you will have access to change any values inputted by the patient as required.
    ...
    <img
      src="/images/air_provider/fill_a_chart_note/functional_outcomes/functional_outcomes_1.webp"
      alt="Fotm View2 Web"
      style={{ width:"79%" }}
    />
  ...
  **Adding and Completing a Form During an Appointment:**
  ...
  - In **Functional Outcomes** section, you can click the **"Add a functional outcome form"** dropdown → Select the desired form template (e.g., KOOS, QuickDASH, or Berg Balance Scale).
    ...
    <img
      src="/images/air_provider/fill_a_chart_note/functional_outcomes/functional_outcomes_2.png"
      alt="Add Fotm Pn"
      style={{ width:"64%" }}
    />
  ...
  **Viewing functional outcome measurements History:**
  ...
  - A table showing the history of scores for that form will appear.
    ...
    ![Fotm History2 Web](/images/air_provider/fill_a_chart_note/functional_outcomes/functional_outcomes_1.webp)
