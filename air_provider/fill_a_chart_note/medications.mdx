...
description: "Learn how to prescribe medications, review medication history, manage custom SIGs, and handle pharmacy requests in Air."
---
...
<Card title=" ">
  ...
  ![Medications Page Web](/images/air_provider/fill_a_chart_note/medications/medications_1.webp)
  ...
  **To Add a new Medication:**
  ...
  - Review the **Associated Appointment**. Air selects the most recent **Checked In** or **Completed** appointment by default. If neither is available, Air selects the most recent eligible appointment. You can select a different appointment when needed.
    ...
    <img
      src="/images/air_provider/fill_a_chart_note/medications/medications_1.webp"
      alt="Create Rx Web"
      title="Create Rx Web"
      style={{ width:"32%" }}
    />
  - Select the \*\*+ icon \*\*to the right to select a Pharmacy (if a favorite pharmacy is selected it will auto-populate)
    ...
    ![46 Rx Open Gi](/images/air_provider/fill_a_chart_note/medications/medications_5.gif)
  ...
  - After you update preferred pharmacies and click **Save**, the dialog closes. Air keeps the current pharmacy if it is still in the saved list. If you removed it and at least one preferred pharmacy remains, Air selects the first saved pharmacy.
    ...
    ![47 Rx Pharmacy Choice Gi](/images/air_provider/fill_a_chart_note/medications/medications_5.gif)
  ...
  - Enter the prescription SIG or select from the saved SIGs
    ...
    ![48 Rx Prescribe Gi](/images/air_provider/fill_a_chart_note/medications/medications_5.gif)
  ...
  - Air preserves the **Earliest Fill Date** when you edit or re-order the prescription, including prescriptions created from a Medication Order Set.
...
### Re-order Multiple Medications from a Visit Note

**Prerequisite:** Open a patient's visit note that has active medications in the **Medications** section.

1. Select the medications you want to prescribe again.
2. Click **Re-order**.
3. Review the prefilled medications, make any needed changes, and continue through the medication order flow.
...
<Card title=" ">
  ...
  ![43 Med History Gi](/images/air_provider/fill_a_chart_note/medications/medications_5.gif)
</Card>
...
<Card title=" ">
  ...
  ![45 New Sig Gi](/images/air_provider/fill_a_chart_note/medications/medications_5.gif)
</Card>
...
<Card title=" ">
  ...
  ![Pharmacy Req1 Web](/images/air_provider/fill_a_chart_note/medications/medications_1.webp)
  ...
  1. Manage Unrecognized Patients
     ...
     ![Rx Link Pharma Request Web](/images/air_provider/fill_a_chart_note/medications/medications_1.webp)
  2. Manage Existing Requests
     - Click Review for a Request
     - Review details and mark Approve, Replace or Deny

     ![Request Pharma Approve Web](/images/air_provider/fill_a_chart_note/medications/medications_1.webp)
</Card>

### FAQ

<Accordion title="Which appointment does Air associate with a new medication by default?">
...
<Accordion title="Can I associate a new medication with a different appointment?">
