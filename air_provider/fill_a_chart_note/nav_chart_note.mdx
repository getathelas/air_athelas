...
description: "Learn how to open, complete, review, and submit a Chart Note in Air."
---
...
### <Icon icon="clipboard-list" iconType="duotone" color="#F9345F" size={23} /> **Orders**

The **Orders** section appears in its own group in the left sidebar, separate from **Other**. See [Orders](/air_provider/fill_a_chart_note/orders) for the available order types and other ways to manage orders.
