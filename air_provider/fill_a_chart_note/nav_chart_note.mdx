...
<Card title=" ">
  ...
  ![4 Nav Ptpage Gi](/images/air_provider/fill_a_chart_note/nav_chart_note/nav_chart_note_3.gif)
  ...
  **Note:** You must check-in the appointment before you can open its Chart Note.
  ...
  ![20 View Chart Note Gi](/images/air_provider/fill_a_chart_note/nav_chart_note/nav_chart_note_3.gif)
...
<Card>
  ...
  ![22 Plan Of Care Gi](/images/air_provider/fill_a_chart_note/nav_chart_note/nav_chart_note_3.gif)
</Card>
...
<Card>
  ...
  - [**Medications**](https://trainings.air.athelas.com/chart_note/medications), [**Medication Order Set**](https://trainings.air.athelas.com/chart_note/medication_order_set), and [**Prescriber Agents**](https://trainings.air.athelas.com/chart_note/prescriber_agents)
...
<Card>
  ...
  ![29 Start Scribe Gi](/images/air_provider/fill_a_chart_note/nav_chart_note/nav_chart_note_3.gif)

  - End or cancel the recording when finished

  ![30 Stop Scribe Gi](/images/air_provider/fill_a_chart_note/nav_chart_note/nav_chart_note_3.gif)
...
<Card>
  ...
  ![8 Commandk Gi](/images/air_provider/fill_a_chart_note/nav_chart_note/nav_chart_note_3.gif)
</Card>
...
<Card>
  ...
  ![27 Ai Dictation Gi](/images/air_provider/fill_a_chart_note/nav_chart_note/nav_chart_note_3.gif)
</Card>
...
<Card>
  ...
  **Note**: You can customize your text snippets from the **Preferences tab.**
  ...
  ![25 Text Snippets Gi](/images/air_provider/fill_a_chart_note/nav_chart_note/nav_chart_note_3.gif)
</Card>
...
<Card>
  ...
  ![41 Preview Pdf Gi](/images/air_provider/fill_a_chart_note/nav_chart_note/nav_chart_note_3.gif)
</Card>
...
<Card title=" ">
  ...
  <Accordion title="View and download updated Note">
    Once a Chart Note is completed, it becomes visible in the [Appointments section](https://trainings.air.athelas.com/patient_details/patient_appts#view-chart-notes-for-an-appointment) of the Patient’s Profile.
  </Accordion>
  ...
  <Accordion title="Fax a Chart Note">
    ...
    ![39 Fax Docs Gi](/images/air_provider/fill_a_chart_note/nav_chart_note/nav_chart_note_3.gif)
  ...
  <Accordion title="Discharge your Patient">
    ...
    - \*\*If the patient does not visit the office: \*\*Discharge the patient from the [case table within the Patient Profile](https://trainings.air.athelas.com/patient_details/patient_demog#active-and-discharged-cases)
  </Accordion>
</Card>
...
<Card>
  ...
  **Open the recent-most Progress note / Initial Eval for the patient:**
  ...
  - Click the **eye icon** to **view the PDF**, then **download** the PDF to your device.
    ![50 Old Ehr Import 1 Gi](/images/air_provider/fill_a_chart_note/nav_chart_note/nav_chart_note_3.gif)
  ...
  **Add the note to the relevant appointment:**
  ...
  - Review, edit if needed, and exit (**_auto-saves, no signature required_**). This information should then start pulling into all future notes made on Air.
    ![51 Old Ehr Import 2 Mp4 Gi](/images/air_provider/fill_a_chart_note/nav_chart_note/nav_chart_note_3.gif)
</Card>