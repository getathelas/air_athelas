...
description: "Open, complete, review, and submit chart notes in Air."
---
...
### <Icon icon="clock-rotate-left" iconType="duotone" color="#F9345F" size={23} />  **Open a recently viewed note**

**Prerequisite:** Use Air on a desktop browser and open at least one chart note.

The **Recently Viewed Notes** button in the patient header keeps a browser-local list of up to 10 notes you recently viewed for other patients.

1. Open a patient profile.
2. Click **Recently Viewed Notes** in the desktop patient header.
3. Select a note under **Recently viewed** to open it.

The current patient's notes are excluded from this menu. If you clear browser data or use a different browser, the list may be empty.
