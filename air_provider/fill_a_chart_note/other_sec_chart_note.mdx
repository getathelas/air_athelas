...
<Card title=" ">
  ...
  **To delete a measurement:** Go to Manage and remove the measurement from the right panel on **Selected Measurements.**
  ...
  ![21 Add Measurements Gi](/images/air_provider/fill_a_chart_note/other_sec_chart_note/other_sec_chart_note_4.gif)

  Measurements are divided into industry-standard types (Observation, Inspection, etc.) and groups.

  <img
    src="/images/air_provider/fill_a_chart_note/other_sec_chart_note/other_sec_chart_note_4.webp"
  ...
  <Danger>
    ✨ **Smart Tip**: You can add your own customized [Measurements and Groups in Preferences](https://trainings.air.athelas.com/admin/chart_note_templates#create-custom-preferences)
  </Danger>
</Card>
...
<Card title=" ">
  ...
  ![23 Goals Gi](/images/air_provider/fill_a_chart_note/other_sec_chart_note/other_sec_chart_note_4.gif)
...
<Card title=" ">
  ...
  **Important:** You must first enter the ICD-10 codes in the _Diagnosis_ section of the chart note. They will then become available in the _Treatments_ section, where you can map each CPT code to the relevant ICD-10 codes.

  ![42 Treatments New Gi](/images/air_provider/fill_a_chart_note/other_sec_chart_note/other_sec_chart_note_4.gif)
  ...
  ![Treatments Web](/images/air_provider/fill_a_chart_note/other_sec_chart_note/other_sec_chart_note_4.webp)

  <Danger>
    ✨ **Smart Tip**: You can configure your own [Treatment information in Preferences](https://trainings.air.athelas.com/admin/chart_note_templates#create-custom-preferences).
  </Danger>
</Card>
...
<Card title=" ">
  ...
  Learn more about visit alerts [here](https://trainings.air.athelas.com/front_desk/prep_appt#track-visit-alerts).

  ![24 Visits Gi](/images/air_provider/fill_a_chart_note/other_sec_chart_note/other_sec_chart_note_4.gif)
</Card>
...
<Card title=" ">
  ...
  **Note:** Adding a **Flowsheet** section will remove the **Treatments** section.
  ...
  ![Add Note Section Web](/images/air_provider/fill_a_chart_note/other_sec_chart_note/other_sec_chart_note_4.webp)
</Card>
...
<video controls className="w-full aspect-video rounded-xl" src="https://demo.arcade.software/HKpQWzMWMsAGvIEM7ydu?embed&embed_mobile=tab&embed_desktop=inline&show_copy_link=true" />