...
| :-- | :-- |
| **Staff & permission management** | Roles with page- and action-level permission gates, scoped by site or facility. |
...
| **Stripe account & POS setup** | Athelas sets up your Stripe account and gets your card readers live. Reader hardware is purchased by your practice. |
...
| **What the payer covers** | What the payer returns, in plain English. |
...
| **Copy charges to another facility** | As-is, or scaled to a different rate. |
...
| Capability | What it is |
| :-- | :-- |
| **Rules that fix or hold a claim** | Scrub, split, hold, or block claims, and view, toggle, and prioritize the rules that do it. |
| **Review a rule before it goes live** | New rules stay inactive until you deliberately activate them. |
| **AI rule generation** | Describe a rule in plain language and get a working draft. |
| **See which claims a rule would touch** | The claims and appointments a rule would affect, before you launch it. |
...
| **Gradual rollout for new rules** | New rules apply to a sample of claims first, then expand. |
| **Claim scrubbing before submission** | Build and validate a claim without sending it. |
...
| **Send records with a claim** | Send supporting records by fax, email, mail, or electronically. |
| **Ask the Assistant about many claims at once** | Ask anything and act across one claim or every claim you selected. |
| **The whole claim on one screen** | Submissions, remittances, payments, and attachments side by side. |
| **NDC drug codes filled in automatically** | Correct NDC, units, and drug details filled in automatically on drug claims. |
| **Automatic data pull from your EHR** | Scheduled pull of appointments, encounters, charges, and records from your existing EHR. |
| **Fresh eligibility on every claim** | Eligibility is refreshed and attached to the claim before it goes out. |
| **Create a claim manually** | Build a claim from scratch, with the same rules and validation as any other. |
...
| **Override a block on one encounter** | Release a single encounter past a submission block, with documented justification. |
...
| **Posting review tool** | Preview any posting action before it takes effect. |
...
| **Remittances that post themselves** | Balanced remittances post with no manual touch; only exceptions are held. |
...
| Capability | What it is |
| :-- | :-- |
| **Patient responsibility, calculated automatically** | Works out what the patient owes, then creates the charge. |
...
| **Failed payment-plan charges are flagged** | Detected and recorded the moment a scheduled charge fails, so nothing goes quietly unpaid. |
| **Why a patient owes what they owe** | A line-by-line breakdown of the balance, charge by charge. |
...
| **Every card event hits your ledger** | Charges, refunds, disputes, and payouts, all written as they happen. |
