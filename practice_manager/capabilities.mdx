...
Every capability in Practice Manager, grouped the same way as the sidebar. Open the matching section for the full description and a link to its guide where one exists.
...
| **Appointment type & calendar setup** <Icon icon="laptop-medical" iconType="duotone" color="#F9345F" size={16} /> | Appointment types, templates, and provider hours. |
| **Athelas Assistant** <Icon icon="flask" iconType="duotone" color="#F9345F" size={16} /> | AI copilot that answers plain-English questions about your live billing data. |
...
| **Patient eligibility report** <Icon icon="flask" iconType="duotone" color="#F9345F" size={16} /> | Coverage-status roster with CSV export. |
| **Prior-auth tracking** <Icon icon="flask" iconType="duotone" color="#F9345F" size={16} /> | Worklist for authorizations, referrals, and their statuses. |
...
| **Kiosk check-in** <Icon icon="flask" iconType="duotone" color="#F9345F" size={16} /> <Icon icon="laptop-medical" iconType="duotone" color="#F9345F" size={16} /> | Patients check themselves in on a lobby tablet, confirming their details and insurance and paying what they owe. |
...
| **AI rule generation** <Icon icon="flask" iconType="duotone" color="#F9345F" size={16} /> | Describe a rule in plain language and get a working draft. |
| **Rule impact preview** <Icon icon="flask" iconType="duotone" color="#F9345F" size={16} /> | The claims and appointments a rule would affect, before you launch it. |
...
| **Test a rule against past claims** <Icon icon="flask" iconType="duotone" color="#F9345F" size={16} /> | A before-and-after comparison of what the rule would have changed. |
...
| **AI filters** <Icon icon="flask" iconType="duotone" color="#F9345F" size={16} /> | Describe the view you want and let AI sort, group, and filter. |
...
| **Adjustment code management** <Icon icon="flask" iconType="duotone" color="#F9345F" size={16} /> | Standard adjustment codes, viewable and mappable per site. |
...
| **Appeals** <Icon icon="flask" iconType="duotone" color="#F9345F" size={16} /> | AI-drafted appeal letters, packet assembled and filed on the payer's channel. |
...
| **AI report builder** <Icon icon="flask" iconType="duotone" color="#F9345F" size={16} /> | Ask a plain-English question and get a live report you can save. |
