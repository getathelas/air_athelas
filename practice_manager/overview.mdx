...
A handful of capabilities in this handbook only apply if you run Air, scheduling and check-in mainly. Those rows carry a marker, so you can tell at a glance what applies to you.
