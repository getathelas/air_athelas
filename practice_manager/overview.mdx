...
Practice Manager is the same platform our RCM Managed Services team runs on. The difference is who sits at the controls.
...
**The daily work.** Your billers review and correct claims, work denials and appeals, post remittances, send patient statements, and answer the patients who call about a bill — every inbound billing call routes to your team, so the person answering knows both the practice and the patient. [Assign and group claims by owner](/practice_manager/rules_and_submission) so each biller works their own list, and every action is available in bulk.

**Where you'll pick up the phone.** A few things need a person on a payer line, and that person is on your team:

- **Prior authorization.** Eligibility tells you what's covered. Confirming whether a service needs prior authorization takes a conversation with the payer, and that conversation is yours.
- **Workers' comp.** Registration and follow-up are yours, with first-class fields in the product rather than workarounds.
- **Paper payers.** A few payers still require a mailed claim. You build it in Practice Manager exactly as you would an electronic one, and your team drops it in the mail.
- **Eligibility gaps.** Eligibility runs through the clearinghouse. When a payer isn't reachable there, your team handles the call into the payer.
...
Each row lists what the capability does, whether it is generally available or in beta, and links to its guide.

| Label | Meaning |
| :-- | :-- |
| **PM** | Generally available to every Practice Manager site. |
| **Beta** | In product and working, but still being refined or not yet fully self-serve for every site. Ask your Athelas team about turning the capability on. |
