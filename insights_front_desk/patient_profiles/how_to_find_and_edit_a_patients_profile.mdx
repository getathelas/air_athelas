...
**Only a patient's contact and mailing information can be updated in Insights.** To edit basic identifying information like name or date of birth, update it in your EHR (or contact [support@getathelas.com](mailto:support@getathelas.com)); Athelas reflects those changes in Insights within 24 hours.
...
**Claims** — all of the patient's claims (functionally the same as filtering the [Claim Details page](/insights_biller/claim_details/claim_details_page) by this patient). See [How to Resubmit Claim(s)](/insights_front_desk/patient_profiles/how_to_resubmit_claims).
