...
description: "An optional threshold that lets Athelas auto-resolve encounters once a payer's payout is acceptable."
---

When balancing encounters and closing out A/R, Athelas automatically resolves denial adjustments we've confirmed aren't realistically workable. That works for common adjustments, but becomes less effective across the long tail of thousands of adjustment combinations. **Target Allowed Amounts** are a complementary strategy for that long tail.

#### What Is a Target Allowed Amount?

A Target Allowed Amount (TAA) answers the question: *how much do you realistically expect to earn for this claim?* With a TAA set, Athelas can identify encounters where the payout is acceptable, write off the remaining balance, and finalize the encounter — reducing unnecessary inflation of your A/R metrics.
...
- Athelas identifies your most common **claim configurations** (a unique combination of procedures — CPT/modifier/units — plus payer and place of service).
