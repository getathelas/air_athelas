...
- **Card Fees** — set the percentage charged to patients paying by card, or toggle **Use exact Stripe fee** (2.9% + \$0.30 per transaction). Toggle **Auto-Save patient credit cards** on or off. See [Manage Credit Cards](/insights_front_desk/patient_responsibility/manage_credit_cards).
...
Map out-of-network insurances so Athelas can run eligibility and provide PR suggestions for those patients.
