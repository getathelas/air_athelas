...
<Warning>
  Mailing a paper statement costs your practice **\$1 per statement** (unless your contract states otherwise).
</Warning>
...
<Accordion title="How much does a paper statement cost?">
  \$1 per statement mailed, unless your contract states otherwise. Reserve paper for patients who don't respond to digital statements.
</Accordion>
