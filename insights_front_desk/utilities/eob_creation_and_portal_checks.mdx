...
- Post checks for non-Insights claims

### FAQ

<Accordion title="Am I required to upload a file for my EOB?">
  No, uploading a file or screenshot is optional (but it's strongly encouraged for record keeping).
</Accordion>

<Accordion title="What types of remittances can I upload?">
  You can upload an `EOB`, data from a `Payer Portal` check, or info from `Calling a Payer`.
</Accordion>

<Accordion title="Should I use this tool to upload EOBs I want the Athelas team to process?">
