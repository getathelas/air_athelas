...
From the [Appointments](https://insights.athelas.com/appointments) page, click **Walk-In Patient**. A **Charge Walk-In Patient** window opens and walks you through two steps.
