...
### <Icon icon="dollar-sign" iconType="duotone" color="#F9345F" size={23} />  Insights Notes
...
<Accordion title="What's the difference between an EHR note, an Insights note, and a Universal note?">
