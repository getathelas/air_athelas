...
### <Icon icon="filter" iconType="duotone" color="#F9345F" size={23} /> Create Saved Views

<Card title="Saved Views">
  <video controls className="w-full aspect-video rounded-xl" src="https://app.arcade.software/share/SlEgZiB9PENbxvrNT2sS" />
...
### <Icon icon="timer" iconType="duotone" color="#F9345F" size={23} />  Calendar Preferences

<Card title="Time Preferences: ">
...
<Card title='Hover over the "Info" icon next to the calendar dates to open the Icon Legend:'>
  <Frame>
    ![Calendar icon legend listing appointment and eligibility icons](/images/air_front_desk/view_your_calendar/nav_calendar/nav_calendar_6.png)
  </Frame>
</Card>
...
<Card title=" ">
  ...
  <Frame>
    ![Appointment block showing stage counts in the hover tooltip](/images/air_front_desk/view_your_calendar/nav_calendar/nav_calendar_7.png)
  </Frame>
</Card>
