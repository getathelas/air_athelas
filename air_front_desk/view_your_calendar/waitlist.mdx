...
1. **Navigate to the Requests tab** in the lower right corner of the Calendar view.
   ...
   ![Requests tab in Calendar view](/images/air_front_desk/view_your_calendar/waitlist/waitlist_5.webp)

2. **Click Add to Waitlist** at the bottom of the drawer. All current waitlist entries and approval requests appear here.

   ![Add to Waitlist button](/images/air_front_desk/view_your_calendar/waitlist/waitlist_6.webp)

3. **Edit the patient and their appointment preferences** — including provider, facility, appointment type, and preferred times.

   ![Edit patient waitlist preferences](/images/air_front_desk/view_your_calendar/waitlist/waitlist_7.webp)

4. **Confirm.** The patient appears at the bottom of the existing waitlist entries.

   ![Patient added at bottom of waitlist](/images/air_front_desk/view_your_calendar/waitlist/waitlist_8.webp)
...
6. **Hover over the (i) icon** to see the details of the waitlist entry.
   ...
   ![Hover icon reveals waitlist entry details](/images/air_front_desk/view_your_calendar/waitlist/waitlist_9.webp)
...
![Cancellation popup with waitlist entries](/images/air_front_desk/view_your_calendar/waitlist/waitlist_10.webp)
...
<Columns cols={2}>
  <img src="/images/air_front_desk/view_your_calendar/waitlist/waitlist_11.webp" alt="Waitlist offer SMS" title="Waitlist offer — SMS" />
  <img src="/images/air_front_desk/view_your_calendar/waitlist/waitlist_12.webp" alt="Waitlist offer email" title="Waitlist offer — email" />
</Columns>
...
![Patient accept/reject offer screen](/images/air_front_desk/view_your_calendar/waitlist/waitlist_13.webp)
...
![Expired offer message](/images/air_front_desk/view_your_calendar/waitlist/waitlist_14.webp)
...
![Accepted offer converted to appointment](/images/air_front_desk/view_your_calendar/waitlist/waitlist_15.webp)
...
![Waitlist settings in Calendar preferences](/images/air_front_desk/view_your_calendar/waitlist/waitlist_16.webp)
...
![Waitlist bucket / expiration timeline example](/images/air_front_desk/view_your_calendar/waitlist/waitlist_17.webp)
