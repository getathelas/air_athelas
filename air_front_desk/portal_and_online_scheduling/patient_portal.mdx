...
description: "Invite patients to the portal and configure the appointments, messages, forms, payments, and home exercise content they can access."
toc: "true"
---
...
**Prerequisite:** You need admin access to **EHR Preferences → Portal Configs**.

Use the **Portal Components** section to control which sections patients can see in the portal. The **Home Exercises tab** setting is on by default.

1. Open **EHR Preferences → Portal Configs**.
2. Scroll to **Portal Components**.
3. Turn **Home Exercises tab** on or off.
4. Click **Save Changes**. Use **Reset Changes** to restore the last saved setting.

When this setting is off, the **Home Exercises** entry is hidden from the patient portal sidebar and home page.
