...
description: "Create and manage single or recurring patient appointments in Air."
---
...
<Card title>
  ...
  ![1 Apptnew Mp4 Gi](/images/air_front_desk/take_in_a_patient/new_appt/new_appt_4.gif)
</Card>
...
<Card title>
  ...
  **Note:** Multiple appointments can be scheduled in the same slot. Air will warn you but won’t block it.
  ...
  ![2 Copypasteappt Gi](/images/air_front_desk/take_in_a_patient/new_appt/new_appt_4.gif)
</Card>
...
<Card title>
  ...
  **Option 3:** Go to Patient Profile → Click on the**New Appointment**  button in the top-right corner
  ...
  When you select an **Appointment Type**, Air updates the **End Time** based on that type's configured duration. If you opened the panel from a calendar time slot, Air keeps the prefilled time range until you select an appointment type.

  ![10 Newappt Manual Gi](/images/air_front_desk/take_in_a_patient/new_appt/new_appt_4.gif)
  ...
  **Note:** Clicking **Sync to Case** saves the insurance, priority, and prior authorization to the case, so they auto-populate for future appointments tied to that case.
  ...
  <img
    src="/images/air_front_desk/take_in_a_patient/new_appt/new_appt_1.webp"
    alt="New Appt Web"
    title="New Appt Web"
    style={{ width:"75%" }}
  />
...
<Card title>
  ...
  ![18 Newcase Gi](/images/air_front_desk/take_in_a_patient/new_appt/new_appt_4.gif)
...
<Card title>
  ...
  ![13 Refprovider Gi](/images/air_front_desk/take_in_a_patient/new_appt/new_appt_4.gif)
