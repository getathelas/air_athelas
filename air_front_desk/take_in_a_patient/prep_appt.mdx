...
<Card title>
  ...
  ![Appt Status Web](/images/air_front_desk/take_in_a_patient/prep_appt/prep_appt_1.webp)
</Card>
...
<Card title>
  ...
  ![11 Editappt Gi](/images/air_front_desk/take_in_a_patient/prep_appt/prep_appt_4.gif)

  <img
    src="/images/air_front_desk/take_in_a_patient/prep_appt/prep_appt_1.webp"
...
<Card title>
  ...
  **Note**: You can send **Functional Outcome Measurement Forms** as well through this flow
  ...
  ![14 Sendforms Gi](/images/air_front_desk/take_in_a_patient/prep_appt/prep_appt_4.gif)
...
<Card title>
  ...
  ![15 Priorauth Gi](/images/air_front_desk/take_in_a_patient/prep_appt/prep_appt_4.gif)
  ...
  **Tracking Prior Auth Status:**
  ...
  ![Prior Auth Track Jpe](/images/air_front_desk/take_in_a_patient/prep_appt/prep_appt_2.jpeg)
  ...
  ![Auth Expiry Jpe](/images/air_front_desk/take_in_a_patient/prep_appt/prep_appt_2.jpeg)
</Card>
...
<Card title>
  ...
  **Updating visit limits:** You can manually update the visit counts for the given options and create **custom** visit counts if needed. 
  ...
  - Click on custom start date to start the visit count from a date that is not the date of appointment
    ...
    <img
      src="/images/air_front_desk/take_in_a_patient/prep_appt/prep_appt_2.jpeg"
  ...
  **Expanding this section provides a detailed view, including:**    
  ...
  ![16 Visitalerts Gi](/images/air_front_desk/take_in_a_patient/prep_appt/prep_appt_4.gif)

  You can customize these limits to be hard alerts or soft alerts from **Preferences**.

  ![Chart Note Limits Web](/images/air_front_desk/take_in_a_patient/prep_appt/prep_appt_1.webp)
...
<Card title=" ">
  ...
  **From the calendar**
  ...
  - Click print to download the schedule. It will include the list of upcoming appointments for the patient, facility address and phone number
    ...
    ![Appt Schedule2 Jpe](/images/air_front_desk/take_in_a_patient/prep_appt/prep_appt_2.jpeg)
  ...
  **From the patient profile**
  ...
  ![Appt Schedule3 Jpe](/images/air_front_desk/take_in_a_patient/prep_appt/prep_appt_2.jpeg)
</Card>