...
<Card>
  ...
  **To save a view:**
  ...
  The new view becomes the selected chip.

  <img
    src="/images/air_admin/manage_your_practice/plan_of_care_tracking/plan_of_care_tracking_11.webp"
    alt="Filter row with an Insurance Type filter applied and the Name your view field open above it, with Cancel and Save View buttons"
    title="Saving a View"
    style={{ width:"70%" }}
  />
...
<Card>
  ...
  **Available actions**
  ...
  Actions run as soon as you click them. There is no confirmation step.
