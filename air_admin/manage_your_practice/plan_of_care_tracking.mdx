...
<video controls className="w-full aspect-video rounded-xl" src="https://app.arcade.software/share/c4OKl0dVGiTFceIGUM6S" />
...
<Card>
  ...
  **Note:** This applies only to initial certifications. The checkbox is not available for recertification cases.
  ...
  <video controls={true} className="w-full aspect-video rounded-xl" src="https://app.arcade.software/share/8pbqT98eF1HeodbWNNEn" />
