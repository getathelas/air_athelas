...
<video controls className="w-full aspect-video rounded-xl" src="https://drive.google.com/file/d/1A9bUyyRqv5L7sGMTPOa7qxDW71-JVnc3/view?usp=sharing" />
...
<Card>
  ...
  ![New Template Web](/images/air_admin/manage_your_practice/chart_note_templates/chart_note_templates_13.webp)
  ...
  ![Template Types Web](/images/air_admin/manage_your_practice/chart_note_templates/chart_note_templates_13.webp)
  ...
  **Components available include:**
  ...
  <AccordionGroup>
    <Accordion title="Single Choice">
      ...
      ![Template Single Choice Web](/images/air_admin/manage_your_practice/chart_note_templates/chart_note_templates_13.webp)
    </Accordion>

    <Accordion title="Short Answer">
      Accepts short, typed responses.

      ![Template Short Ans Web](/images/air_admin/manage_your_practice/chart_note_templates/chart_note_templates_13.webp)
    </Accordion>

    <Accordion title="Multiple Choice">
      Ask a question with multiple selectable answers.

      ![Template Multiple Choice Web](/images/air_admin/manage_your_practice/chart_note_templates/chart_note_templates_13.webp)
    </Accordion>

    <Accordion title="Paragraph Answer">
      Accepts longer, free-text responses.

      ![Template Para Ans Web](/images/air_admin/manage_your_practice/chart_note_templates/chart_note_templates_13.webp)
    </Accordion>

    <Accordion title="Yes/No Question">
      Provides a binary choice.

      ![Template Yes No Ans Web](/images/air_admin/manage_your_practice/chart_note_templates/chart_note_templates_13.webp)
    </Accordion>

    <Accordion title="Number Answer">
      Accepts numeric input.

      ![Template No Ans Web](/images/air_admin/manage_your_practice/chart_note_templates/chart_note_templates_13.webp)
    </Accordion>

    <Accordion title="Rating Question">
      Collects a rating (e.g., 1–5 scale).

      ![Template Rating Web](/images/air_admin/manage_your_practice/chart_note_templates/chart_note_templates_13.webp)
    </Accordion>

    <Accordion title="Table Answer">
      Displays responses in a table format, with columns added using the **\+** button.

      ![Template Table Web](/images/air_admin/manage_your_practice/chart_note_templates/chart_note_templates_13.webp)
    </Accordion>

    <Accordion title="Date Question">
      Accepts a date input.

      ![Template Date Web](/images/air_admin/manage_your_practice/chart_note_templates/chart_note_templates_13.webp)
    </Accordion>

    <Accordion title="Text Box">
      Only available for patient intake forms (not EHR templates).

      ![Template Text Web](/images/air_admin/manage_your_practice/chart_note_templates/chart_note_templates_13.webp)
    </Accordion>
  </AccordionGroup>
</Card>
...
<Card title=" ">
  **How to create a Compliance Checkmark**
  ...
  ![Compliance New Web](/images/air_admin/manage_your_practice/chart_note_templates/chart_note_templates_13.webp)
...
<Card title=" ">
  ...
  ![Measurement Categories Web](/images/air_admin/manage_your_practice/chart_note_templates/chart_note_templates_13.webp)
  ...
  **Measurements can be displayed in two formats:**
  ...
  - **Text Type:** Fields appear as single-line entries (best for a few simple measurements).
    <img
      src="/images/air_admin/manage_your_practice/chart_note_templates/chart_note_templates_13.webp"
      alt="Measurement New Text 2 Web"
      title="Measurement New Text 2 Web"
      style={{ width:"69%" }}
    />
  - **Table Type:** Fields are displayed in a table format (best when comparing bilateral values, e.g., left vs. right knee). <img src="/images/air_admin/manage_your_practice/chart_note_templates/chart_note_templates_13.webp" alt="New Measurement 3 Web" />

  **Measurement Groups:** Measurements can be grouped by intuitive groups.

  ![Measurement Groups2 Web](/images/air_admin/manage_your_practice/chart_note_templates/chart_note_templates_13.webp)
  ...
  **Note:** You can also create sub-groups to the group of measurements.
  ...
  ![New Measurement Group Web](/images/air_admin/manage_your_practice/chart_note_templates/chart_note_templates_13.webp)
</Card>
...
<Card title=" ">
  ...
  ![Snippets Preferences Web](/images/air_admin/manage_your_practice/chart_note_templates/chart_note_templates_13.webp)
</Card>