...
![The Team Members page with the Roles sidebar and members table](/images/air_admin/manage_your_practice/user_management/user_management_1.webp)
...
![The New Member form with Basic Info and Permission Roles](/images/air_admin/manage_your_practice/user_management/user_management_2.webp)
...
6. In **Facility Access**, choose **All Facilities** or **Specific Facilities** (pick particular groups and/or facilities from the tree, using **Select all** / **Deselect all** and search to navigate quickly).
   ...
   ![Setting Facility Access when adding a team member](/images/air_admin/manage_your_practice/user_management/user_management_3.webp)
7. Click **Create**.
...
![Confirming removal of a team member](/images/air_admin/manage_your_practice/user_management/user_management_4.webp)
...
![Creating a role from the Roles sidebar](/images/air_admin/manage_your_practice/user_management/user_management_5.webp)
...
3. In the **Role Configuration** panel, enter a **Role Name** (e.g., "Front Desk Lead", "Claims Specialist") and confirm or change the **Role Template**.
   ...
   ![The Role Configuration panel](/images/air_admin/manage_your_practice/user_management/user_management_6.webp)
4. Adjust the permission tree: use the left panel to enable/disable entire packages or pages, click any page with sub-permissions to fine-tune individual features in the right panel, and use **Select all** / **Deselect all** where helpful.
   ...
   ![Adjusting the permission tree for a role](/images/air_admin/manage_your_practice/user_management/user_management_7.webp)
...
![The Create Facility form](/images/air_admin/manage_your_practice/user_management/user_management_8.webp)
...
![The Create Group form](/images/air_admin/manage_your_practice/user_management/user_management_9.webp)
...
![Editing a facility group](/images/air_admin/manage_your_practice/user_management/user_management_10.webp)
...
![The Create Tag form](/images/air_admin/manage_your_practice/user_management/user_management_11.webp)
...
![Editing a facility tag](/images/air_admin/manage_your_practice/user_management/user_management_12.webp)
