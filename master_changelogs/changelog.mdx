...
<Update label="January 30, 2026" tags={["Insights"]}>
  ...
  We've redesigned the Patient Profile page with a new 3-panel layout that makes it easier to understand patient balances and payment history. The redesign includes separate tabs for Charges, Transactions, and Touchpoints, enhanced activity feed showing payment events, improved transaction details display, and contextual Copilot suggestions that adapt to your current view.
  ...
  ### UDS 9D Report for FQHCs

  We've delivered the UDS 9D Report to multiple FQHC customers, providing comprehensive reporting for federal health center requirements. The report is now available for KCS, WFHC, and SunLife with additional sites coming soon.
  ...
  **Eligibility & Benefits:**
  ...
  - Improved eligibility parsing to better handle benefits from multiple insurance carriers
  - Fixed query performance issues on the appointments endpoint for faster page loads
  ...
  **Collections & Reporting:**
  ...
  - Resolved A/R Report discrepancies between Insights calculations and external reports
  - Enhanced report documentation and migrated guides to our new documentation platform
  ...
  **Payment Plans:**
  - Added monitoring alerts for payment plan success rates to ensure reliable automated payments
