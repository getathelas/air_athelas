...
<Update label="Sep 30, 2025" tags={["Insights"]}>
  ...
  <img className="w-full rounded-xl" src="/images/master_changelogs/changelog/2025_09_30/patient-statement-redesign-update.png" alt="Redesigned patient statement in black and white format showing billing summary and payment details" />
