...
<Update label="March 9, 2026" tags={["Air"]}>
  ...
  When your site has more than one template, you can choose one from the patient's print menu or from the **Facesheet Template** field in the bulk **Print Facesheets** dialog.
