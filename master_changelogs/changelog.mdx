...
<Update label="January 31, 2026" tags={["Air"]}>
  ...
  ### [Beta user only] Waitlist launches
  ...
  **Integrations:**
  - Fixed an error where the prior authorization report was broken for Lattimore, preventing staff from viewing authorization statuses
