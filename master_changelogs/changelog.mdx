...
<Update label="Aug 21, 2025" tags={["Air"]}>
  ...
  **Assistant Chart Review gives providers a compliance consultant in their pocket**
  <video controls className="w-full aspect-video rounded-xl">
    <source src="/images/master_changelogs/changelog/2025_08_21/videoplayback (4).mp4" type="video/mp4" />
  ...
  **Voice mode lets you talk directly to Assistant**
  ...
  <video controls className="w-full aspect-video rounded-xl">
    <source src="/images/master_changelogs/changelog/2025_08_21/videoplayback (3).mp4" type="video/mp4" />
    Your browser does not support the video tag.
  </video>
  ...
  **Create Tasks directly from Attachments page**
  ...
  <video controls className="w-full aspect-video rounded-xl">
    <source src="/images/master_changelogs/changelog/2025_08_21/videoplayback (2).mp4" type="video/mp4" />
    Your browser does not support the video tag.
  </video>
...
<Update label="Aug 13, 2025" tags={["Air"]}>
  ...
  **AI text quick-editing accessed through “Command-K”**
  ...
  <video controls className="w-full aspect-video rounded-xl">
    <source src="/images/master_changelogs/changelog/2025_08_13/videoplayback (1).mp4" type="video/mp4" />
    Your browser does not support the video tag.
  </video>
</Update>
...
<Update label="Aug 08, 2025" tags={["Air"]}>
  ...
  **Create tasks directly from your Fax page and refer back to those auto-linked faxes in the Tasks page**
  ...
  <video controls className="w-full aspect-video rounded-xl">
    <source src="/images/master_changelogs/changelog/2025_08_08/videoplayback.mp4" type="video/mp4" />
    Your browser does not support the video tag.
  </video>
  ...
  **Intelligent AI Fax ingestion will auto-generate leads from faxes**
  ...
  <video controls className="w-full aspect-video rounded-xl">
    <source src="/images/master_changelogs/changelog/2025_08_08/Automatic lead processing Demo - Allison Park (720p, h264, youtube).mp4" type="video/mp4" />
    Your browser does not support the video tag.
  </video>
