...
<Update label="Oct 31, 2025" tags={["Insights"]}>
  ...
  **Patient Statements:**
  - Resolved an issue where patients at multiple sites were not receiving their statements due to delivery failures
...
<Update label="Sep 17, 2025" tags={["Air"]}>
  ...
  **Faxing:**
  ...
  - Implemented a seamless zero-downtime fax service transition process for new sites migrating to the platform
</Update>
