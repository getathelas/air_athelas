---
title: "Setting up Air Clinical"
sidebarTitle: "Set-up Air Clinical"
---

Welcome to Air, your simple and powerful way to manage patients, schedules, and operations in one place.

### <Icon icon="laptop" iconType="duotone" color="#F9345F" size={23} />  Log-in to Air Clinical
...
<Card title=" ">
  ...
  ![Login Web](/images/air_onboard/getting_started_with_air/set_up/set_up_2.webp)
</Card>

### <Icon icon="circle-dot" iconType="duotone" color="#F9345F" size={23} />  Overview of Air Clinical
...
<Card title=" ">
  ...
  ![Overview Web](/images/air_onboard/getting_started_with_air/set_up/set_up_2.webp)
